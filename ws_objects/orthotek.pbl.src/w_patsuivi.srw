$PBExportHeader$w_patsuivi.srw
forward
global type w_patsuivi from w_child
end type
type dw_sat from uo_sat within w_patsuivi
end type
type uo_calutil2 from u_calutil within w_patsuivi
end type
type uo_calutil1 from u_calutil within w_patsuivi
end type
type em_fin from editmask within w_patsuivi
end type
type em_debut from editmask within w_patsuivi
end type
type st_to from statictext within w_patsuivi
end type
type st_from from statictext within w_patsuivi
end type
type cb_find from commandbutton within w_patsuivi
end type
type cb_print from commandbutton within w_patsuivi
end type
type cb_close from commandbutton within w_patsuivi
end type
type dw_patsuivi from u_dw within w_patsuivi
end type
end forward
...
cb_print cb_print
cb_close cb_close
dw_patsuivi dw_patsuivi
end type
global w_patsuivi w_patsuivi
...
this.dw_patsuivi=create dw_patsuivi
...
this.Control[iCurrent+11]=this.dw_patsuivi
end on

on w_patsuivi.destroy
call super::destroy
destroy(this.dw_sat)
...
dw_patsuivi.retrieve(v_no_ortho,gf_emtodate(em_debut.text),gf_emtodate(em_fin.text))
...
gb_datawindow = true
openwithparm(w_print_options,dw_patsuivi)
end event
...
dw_patsuivi.SetTransObject(SQLCA)
end event
