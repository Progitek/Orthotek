$PBExportHeader$w_pour_fact_couttrait.srw
forward
global type w_pour_fact_couttrait from w_child
end type
type em_year from editmask within w_pour_fact_couttrait
end type
type cbx_2 from checkbox within w_pour_fact_couttrait
end type
type cbx_1 from checkbox within w_pour_fact_couttrait
end type
type dw_sat from uo_sat within w_pour_fact_couttrait
end type
type st_1 from statictext within w_pour_fact_couttrait
end type
type cb_find from commandbutton within w_pour_fact_couttrait
end type
type cb_quit from commandbutton within w_pour_fact_couttrait
end type
type cb_imp from commandbutton within w_pour_fact_couttrait
end type
type dw_pour_fact from u_dw within w_pour_fact_couttrait
end type
end forward
...
global w_pour_fact_couttrait w_pour_fact_couttrait
...
on w_pour_fact_couttrait.create
int iCurrent
call super::create
...
on w_pour_fact_couttrait.destroy
call super::destroy
...
em_year.text = string(today(),'dd-mm-yyyy')
end event
...
integer height = 1804
integer taborder = 30
string dataobject = "d_pour_fact_couttrait"
