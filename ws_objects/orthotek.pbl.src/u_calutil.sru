$PBExportHeader$u_calutil.sru
$PBExportComments$Drop-down calendar
forward
global type u_calutil from userobject
end type
type pb_monprev from picturebutton within u_calutil
end type
type pb_monnext from picturebutton within u_calutil
end type
type pb_yrprev from picturebutton within u_calutil
end type
type pb_yrnext from picturebutton within u_calutil
end type
type dw_cal from datawindow within u_calutil
end type
end forward
...
event ue_aff_horaire();istr_calutil.caldate = id_date_selected
visible = false
end event
...
id_date_selected = date(string(Today()))
istr_calutil.caldate = date(today())
