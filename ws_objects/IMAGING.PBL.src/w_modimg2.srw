$PBExportHeader$w_modimg2.srw
forward
global type w_modimg2 from w_child
end type
type shl_visionner from uo_hyperlink_transparent within w_modimg2
end type
type cbx_inverser from checkbox within w_modimg2
end type
type st_5 from statictext within w_modimg2
end type
type st_4 from statictext within w_modimg2
end type
type st_3 from statictext within w_modimg2
end type
type st_2 from statictext within w_modimg2
end type
type p_1 from picture within w_modimg2
end type
type st_im from st_uo_transparent within w_modimg2
end type
type st_op from st_uo_transparent within w_modimg2
end type
type p_18 from picture within w_modimg2
end type
type st_rognage from statictext within w_modimg2
end type
type shl_annuler_rog from uo_hyperlink_transparent within w_modimg2
end type
type shl_undo from uo_hyperlink_transparent within w_modimg2
end type
type shl_moins_luminosite from uo_hyperlink_transparent within w_modimg2
end type
type shl_rognage from uo_hyperlink_transparent within w_modimg2
end type
type shl_plus_luminosite from uo_hyperlink_transparent within w_modimg2
end type
type shl_rotation from uo_hyperlink_transparent within w_modimg2
end type
type shl_symetrie_hor from uo_hyperlink_transparent within w_modimg2
end type
type shl_symetrie_vert from uo_hyperlink_transparent within w_modimg2
end type
type uo_toolbar from u_cst_toolbarstrip within w_modimg2
end type
type uo_toolbar2 from u_cst_toolbarstrip within w_modimg2
end type
type p_image from picture within w_modimg2
end type
type p_carre from picture within w_modimg2
end type
type cb_undo from commandbutton within w_modimg2
end type
type lb_histo from listbox within w_modimg2
end type
type cb_ok from commandbutton within w_modimg2
end type
type p_l4 from picture within w_modimg2
end type
type p_l3 from picture within w_modimg2
end type
type p_l2 from picture within w_modimg2
end type
type p_l1 from picture within w_modimg2
end type
type cb_annuler_rog from commandbutton within w_modimg2
end type
type p_size from picture within w_modimg2
end type
type cb_moins_luminosite from commandbutton within w_modimg2
end type
type cb_plus_luminosite from commandbutton within w_modimg2
end type
type cb_rogne from commandbutton within w_modimg2
end type
type cb_rotation from commandbutton within w_modimg2
end type
type cb_symetrie_hor from commandbutton within w_modimg2
end type
type st_1 from statictext within w_modimg2
end type
type cb_symetrie_vert from commandbutton within w_modimg2
end type
type cb_annuler from commandbutton within w_modimg2
end type
type p_image_base from picture within w_modimg2
end type
type gb_historique from u_gb within w_modimg2
end type
type rr_1 from roundrectangle within w_modimg2
end type
type rr_2 from roundrectangle within w_modimg2
end type
type rr_3 from roundrectangle within w_modimg2
end type
type rr_4 from roundrectangle within w_modimg2
end type
end forward
...
integer i, li_nbops, li_idx = 1, li_fich
...
event clicked;integer i, li_nbops, li_fich
...
//	ChangeDirectory("C:\Program Files\ImageMagick-6.3.4-Q16\")
	...
	for i = 1 to li_nbops
		...
		fileWrite(li_fich, '"convert.exe" "' + is_pathimg + '" ' + is_listop[i] + ' "' + is_pathimg + '"')
		fileWrite(li_fich, '"convert.exe" "' + is_pathimgsmall + '" ' + is_listopsmall[i] + ' "' + is_pathimgsmall + '"')
		setPointer(HourGlass!)
...
//	ChangeDirectory("C:\Program Files\ImageMagick-6.3.4-Q16\")
	...
	//iuo_rnw.of_run("c:\ii4net\orthotek\imagemagick\convert " + is_pathimgcopy + " -crop " + string(ll_wf) + "x" + string(ll_hf) + "+" + string(ll_xf) + "+" + string(ll_yf) + " " + is_pathimgcopy, hide!)
