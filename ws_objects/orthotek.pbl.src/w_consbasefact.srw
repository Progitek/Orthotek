$PBExportHeader$w_consbasefact.srw
forward
global type w_consbasefact from w_child
end type
type uo_calutil2 from u_calutil within w_consbasefact
end type
type uo_calutil1 from u_calutil within w_consbasefact
end type
type cb_print from commandbutton within w_consbasefact
end type
type em_fin from editmask within w_consbasefact
end type
type st_2 from statictext within w_consbasefact
end type
type em_debut from editmask within w_consbasefact
end type
type st_1 from statictext within w_consbasefact
end type
type cb_find from commandbutton within w_consbasefact
end type
type dw_statpatcons from u_dw within w_consbasefact
end type
type cb_close from commandbutton within w_consbasefact
end type
end forward
...
global w_consbasefact w_consbasefact

type variables
DataWindowChild dddwin
end variables

on w_consbasefact.create
int iCurrent
call super::create
...
this.Control[iCurrent+9]=this.dw_statpatcons
this.Control[iCurrent+10]=this.cb_close
end on

on w_consbasefact.destroy
call super::destroy
...
dw_statpatcons.retrieve(v_no_ortho,debut,fin)
end event
...
string dataobject = "d_consbasefact"
boolean border = false
