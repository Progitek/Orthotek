$PBExportHeader$u_calendartpl.sru
$PBExportComments$Drop-down calendar
forward
global type u_calendartpl from userobject
end type
type pb_monprev from picturebutton within u_calendartpl
end type
type pb_monnext from picturebutton within u_calendartpl
end type
type pb_yrprev from picturebutton within u_calendartpl
end type
type pb_yrnext from picturebutton within u_calendartpl
end type
type dw_cal from u_dw within u_calendartpl
end type
end forward
...
global u_calendartpl u_calendartpl
...
public function integer of_gethorshareid ()
end prototypes
...
public subroutine uf_enterdaynumbers (integer ai_start_day_num, integer ai_days_in_month);Long ll_color
...
public function integer of_gethorshareid ();return il_horshareid
end function

on u_calendartpl.create
...
event constructor;id_datetpl_selected = date(string(Today()))
...
id_datetpl_selected = date(ii_year,ii_month,ii_Day)
...
string picturename = "c:\ii4net\orthotek\images\prior.bmp"
boolean map3dcolors = true
string powertiptext = "Previous year"
end type
...
integer height = 2144
integer taborder = 10
string dataobject = "d_calendartpl"
...
w_horaire_template.is_cellname = dwo.name
...
ii_day = Integer(left(dw_cal.GetItemString(1,li_clickedcolumn),2))
...
event rbuttondown;//m_hortpl my_menu
//my_menu = create m_hortpl
//m_hortpl.popmenu (pointerx()+100, pointery()+100)
end event

event constructor;pro_resize luo_resize
luo_resize.uf_resizedw(this)

if v_langue = 'an' then
	this.Object.t_1.text = "Monday"
	this.Object.t_2.text = "Tuesday"
	this.Object.t_3.text = "Wednesday"
	this.Object.t_4.text = "Thursday"
	this.Object.t_5.text = "Friday"
	this.Object.t_6.text = "Saturday"
	this.Object.t_7.text = "Sunday"
end if
end event

event dragdrop;Integer	li_clickedcolumn
String 	ls_day, ls_modify, ls_return
...
w_horaire_template.uo_caltpl.event ue_aff_horaire()
end event
