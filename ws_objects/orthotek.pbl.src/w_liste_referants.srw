$PBExportHeader$w_liste_referants.srw
forward
global type w_liste_referants from w_child
end type
type uo_calutil2 from u_calutil within w_liste_referants
end type
type uo_calutil1 from u_calutil within w_liste_referants
end type
type cb_1 from commandbutton within w_liste_referants
end type
type st_to from statictext within w_liste_referants
end type
type st_from from statictext within w_liste_referants
end type
type em_fin from editmask within w_liste_referants
end type
type em_debut from editmask within w_liste_referants
end type
type cb_close from commandbutton within w_liste_referants
end type
type cb_find from commandbutton within w_liste_referants
end type
type cb_print from commandbutton within w_liste_referants
end type
type dw_liste_referants from u_dw within w_liste_referants
end type
end forward
...
global w_liste_referants w_liste_referants
...
integer height = 1916
integer taborder = 50
string dataobject = "d_liste_referants"
boolean border = false
